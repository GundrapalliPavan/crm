...
/** Every mutation invalidates the list (a filtered row may now match/not-match) and, where
...
export function useCreateFollowUp() {
  return useMutation({
    mutationFn: (request: CreateFollowUpRequest) => leadsApi.createFollowUp(request),
  });
}
